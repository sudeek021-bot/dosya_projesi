...
setState(() {
// ARTIK SAHTE BAKİYE YOK
_balance =
realBalance;

// ARTIK ÖRNEK İŞLEM YOK
_transactions =
realTransactions;
    ...
    return Container(
      ...
      const Column(
        children: [
          ...
          Text(
            "Satış, satın alma veya para çekme işlemleriniz burada görünecek.",
