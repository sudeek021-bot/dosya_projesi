...
class ReviewsScreen extends StatefulWidget {
  ...
  // Bu değer sayısal users.id değil.
  // DeviceService'ten gelen device_id değeridir.
  final String userId;
...
// Yorum özeti
_apiService.getReviewSummary(
noteId: widget.noteId,
),

// Kullanıcının yorum yapma izni
_apiService.reviewPermission(
noteId: widget.noteId,
userId: widget.userId,
),

// device_id -> gerçek sayısal users.id
_apiService.checkUser(
widget.userId,
),
],
);
...
reviewsResult['summary']
is Map
) {
// Eski backend uyumluluğu
summary =
Map<String, dynamic>.from(
reviewsResult['summary']
as Map,
...
// =====================================================
// AKTİF KULLANICININ SAYISAL ID'Sİ
// =====================================================
...
// Backend farklı isimlerden birini
// döndürürse ikisini de kabul et.
_reviewCount =
int.tryParse(
summary[
'review_count']
...
_errorMessage =
'Yorum bilgileri alınırken beklenmeyen bir hata oluştu.';
});
}
}
