...
bool _purchaseCompleted =
false;

bool _usedFreeTrialInThisPurchase =
false;

bool _alreadyPurchased =
false;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _summaryRow(
            title:
            "Ücretsiz hakkınız yoksa toplam",
            value:
            "${_formatMoney(_price)} TL",
            color:
            AppColors.primaryLight,
